...
export default function Footer({ onCategorySelect }) {
  ...
  return (
    <footer className="bg-[#050505] text-white pt-0 pb-0 relative overflow-hidden border-t border-[#222222]">
      
      {/* Luxury VIP Private Circle Banner (No Discount — Pure Exclusivity & Priority Access) */}
      <div className="relative border-b border-[#222222] py-14 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto">
          <div className="bg-gradient-to-br from-[#161616]/90 via-[#111111]/90 to-[#0A0A0A]/90 border border-[#C59F60]/30 rounded-3xl p-8 sm:p-12 shadow-2xl backdrop-blur-xl relative overflow-hidden">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              ...
              <div className="lg:col-span-7 space-y-4 text-left">
                ...
                {/* VIP Status Tag */}
                <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#C59F60]/10 border border-[#C59F60]/40 text-xs font-black text-[#C59F60] uppercase tracking-widest font-mono shadow-sm">
                  <TavoIsotype className="w-4 h-4" glow={false} />
                  <span>CÍRCULO PRIVADO TAVO VIP</span>
                </div>

                {/* Headline */}
                <h3 className="text-2xl sm:text-4xl font-black font-heading text-white tracking-tight leading-tight">
                ...
                <div className="flex flex-wrap gap-2.5 pt-2">
                  <span className="inline-flex items-center gap-1.5 text-[11px] font-bold font-mono text-neutral-300 bg-[#1A1A1A] px-3 py-1.5 rounded-xl border border-[#2A2A2A]">
                    <Sparkles className="w-3.5 h-3.5 text-[#C59F60]" /> Lanzamientos Anticipados
                  </span>
                  <span className="inline-flex items-center gap-1.5 text-[11px] font-bold font-mono text-neutral-300 bg-[#1A1A1A] px-3 py-1.5 rounded-xl border border-[#2A2A2A]">
                    <ShieldCheck className="w-3.5 h-3.5 text-[#C59F60]" /> Asignación Prioritaria
                  </span>
                  <span className="inline-flex items-center gap-1.5 text-[11px] font-bold font-mono text-neutral-300 bg-[#1A1A1A] px-3 py-1.5 rounded-xl border border-[#2A2A2A]">
                    <Crown className="w-3.5 h-3.5 text-[#C59F60]" /> Asesor TAVO 24/7
                  </span>
                </div>
              </div>
              ...
              <div className="lg:col-span-5 flex flex-col justify-center">
                {!subscribed ? (
                  <form onSubmit={handleSubscribe} className="space-y-3">
                    <div className="relative">
                      ...
                      <input
                        type="email"
                        required
                        placeholder="Ingresa tu correo electrónico VIP..."
                        value={email}
                        onChange={(e) => setEmail(e.target.value)}
                        className="w-full bg-[#0A0A0A] text-white placeholder:text-neutral-500 font-medium pl-11 pr-4 py-4 rounded-2xl text-sm focus:outline-none focus:ring-2 focus:ring-[#C59F60] border border-[#333333] shadow-inner transition-all"
                      />
                    </div>
                    
                    <button
                      type="submit"
                      className="w-full btn-gold-primary py-4 rounded-2xl text-sm font-black flex items-center justify-center gap-2 shadow-2xl hover:scale-[1.01] active:scale-[0.99] transition-all"
                    >
                  ...
                  <div className="bg-gradient-to-br from-[#1A1A1A] to-[#141414] border-2 border-[#C59F60] p-6 rounded-2xl text-center space-y-3 shadow-2xl animate-in zoom-in-95 duration-300">
                    <div className="w-12 h-12 rounded-full bg-[#C59F60]/20 text-[#C59F60] flex items-center justify-center mx-auto border border-[#C59F60]/40">
                      <CheckCircle className="w-6 h-6" />
                    </div>
                    <h4 className="text-base font-black font-heading text-white">¡Membresía Confirmada!</h4>
                    <p className="text-xs text-neutral-300 font-medium">
                      Has ingresado al Círculo Privado D'TAVO. Te notificaremos con prioridad de los próximos lanzamientos de tecnología flagship en Colombia.
                    </p>
                  </div>
                )}
              </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 text-left pb-14 border-b border-[#222222]">
          ...
          <div className="lg:col-span-4 space-y-5">
            ...
            <p className="text-sm text-neutral-400 leading-relaxed font-medium max-w-sm">
              La boutique de tecnología de alta gama líder en smartphones insignia, audio de alta fidelidad y computación de élite. Envíos express 24h asegurados a toda Colombia.
            </p>

            {/* Social / Contact Icons */}
            <div className="flex items-center gap-2.5 pt-2">
              <a 
                href="https://wa.me/1234567890?text=Hola%20La%20tienda%20D'TAVO"
                target="_blank"
          ...
          <div className="lg:col-span-2">
            <h4 className="text-xs font-black text-neutral-400 uppercase tracking-[0.2em] mb-5 font-mono">
              Categorías
            </h4>
          ...
          <div className="lg:col-span-3">
            ...
            <ul className="space-y-3.5 text-sm text-neutral-300 font-medium">
          ...
          <div className="lg:col-span-3">
            ...
            <div className="space-y-3">
              {[
                ...
                <div key={i} className="flex items-start gap-3 bg-[#111111] p-3 rounded-xl border border-[#222222]">
                  <div className="w-8 h-8 rounded-lg bg-[#C59F60]/10 flex items-center justify-center shrink-0 mt-0.5 border border-[#C59F60]/20">
                    <Icon className="w-4 h-4 text-[#C59F60]" />
                  </div>
                  <div>
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between text-xs text-neutral-500 gap-4 font-mono">
          <p>© 2026 La tienda D'TAVO. Todos los derechos reservados.</p>
